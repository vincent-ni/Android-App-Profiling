...
# Modified by Matthias Grundmann.
# On success defines the following variables
# IPP_INCLUDE_DIR
# IPP_MERGED_LIBRARIES   - static binding
# IPP_SHARED_LIBRARIES   - dynamic binding
...
FILE(GLOB IPP_INCLUDE_PATHS_3 "/opt/intel/Compiler/*/*/Frameworks/ipp/include")
...
FILE(GLOB IPP_LIBRARY_PATHS_6 "/opt/intel/Compiler/*/*/Frameworks/ipp/lib")
FILE(GLOB IPP_LIBRARY_PATHS_7 "/opt/intel/Compiler/*/*/lib")
FILE(GLOB IPP_LIBRARY_PATHS_8 "/opt/intel/Compiler/*/*/Frameworks/ipp/Libraries")
...
FIND_LIBRARY( IPP_IOMPSHARED     NAMES    iomp5   PATHS ${IPP_LIBRARY_PATHS} )
FIND_LIBRARY( IPP_GUIDESHARED    NAMES    guide   PATHS ${IPP_LIBRARY_PATHS} )
...
IF(NOT IPP_FOUND)
  ...
  IF(IPP_FIND_REQUIRED)
    MESSAGE(FATAL_ERROR
            "IPP required but some headers or libs not found.")
  ELSE(IPP_FIND_REQUIRED)
    MESSAGE(STATUS 
            "ERROR: IPP was not found.")
  ENDIF(IPP_FIND_REQUIRED)
ELSE(NOT IPP_FOUND)
  MESSAGE(STATUS
          "IPP found at ${IPP_INCLUDE_DIR}")
ENDIF(NOT IPP_FOUND)
