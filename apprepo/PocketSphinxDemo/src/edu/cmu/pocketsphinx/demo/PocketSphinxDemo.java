...
public class PocketSphinxDemo extends Activity implements OnTouchListener, RecognitionListener, OnClickListener {
	static {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		Button a = (Button) findViewById(R.id.buttonAudio);
	...
	public void onResults(Bundle b) {
		final String hyp = b.getString("hyp");
		final long vrtime = b.getLong("time");
		final PocketSphinxDemo that = this;
		this.edit_text.post(new Runnable() {
			public void run() {
				...
				that.performance_text.setText(String.format("%.2f seconds %.2f xRT "+vrtime+" ms",
															that.speech_dur,
